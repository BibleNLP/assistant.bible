...
class EmbeddingType(str, Enum):
    ...
    HUGGINGFACE_DEFAULT = "huggingface"  # TODO: add support for multiple models ? # pylint: disable=W0511
    HUGGINGFACE_MULTILINGUAL = "huggingface-multilingual"
    OPENAI = "OpenAI"


class EmbeddingDimensionSize(str, Enum):
    "Available embedding dimension size"
    OPENAI = 1536
...
class SupabaseKeys(BaseModel):
    "Represents Supabase keys containing Supabase URL and Supabase API key"
    supabaseUrl: str
    supabaseKey: str
